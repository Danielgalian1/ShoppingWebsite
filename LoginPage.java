...
public class LoginPage extends BasePage {
	...
	public void login(String user, String Password) {// דף כניסה לאתר פעולות ראשונות
		...
		// fillText( driver.findElement(By.cssSelector("#user-name")),user); // מחיקה
		// טקסט והכנסנ שם חדש פכולה filltext
		// fillText(driver.findElement(By.cssSelector("#password")) ,Password);
		// driver.findElement(By.cssSelector("#user-name")).sendKeys(user); // ובפעול
		// יכניס יוזא וסיסמא
