...
public class RemoveBack extends BasePage  {
    ...
    public void openCarttoo () {
      ...
      //Select selectproduct new = select (driver.findElement(By.cssSelector(".btn_action.checkout_button")));
 // public int nlist() {
    //	String s = getText(driver.findElement(By.cssSelector("product_sort_container")));
	//	click(cLicK);
	//click(cLick);
    }
}
